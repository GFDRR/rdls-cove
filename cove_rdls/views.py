...
from cove_rdls.forms import NewTextForm, NewUploadForm, NewURLForm
...
class NewInput(InputDataView):
    ...
    input_template = "cove_rdls/index.html"
...
def index(request):
    ...
    return render(request, "cove_rdls/index.html", {"forms": forms})


class ExploreRDLSView(ExploreDataView):
    explore_template = "cove_rdls/explore.html"
    processing_template = "cove_rdls/processing.html"
