...
LOCALE_PATHS = (os.path.join(BASE_DIR, 'cove_rdls', 'locale'),)
...
COVE_CONFIG = {
    ...
    'app_verbose_name': 'RDLS Convertor',
    'app_strapline': 'Convert and validate RDLS metdata.',
...
ALLOWED_UNKNOWN_CONTENT_TYPES = settings.ALLOWED_UNKNOWN_CONTENT_TYPES
...
PROCESS_TASKS = [
    ...
    # Sample
    ("cove_rdls.process", "Sample"),
    # Guess format
    ("cove_rdls.process", "SetOrTestSuppliedDataFormat"),
    # Make sure uploads are in primary format
    ("cove_rdls.process", "WasJSONUploaded"),
    ("cove_rdls.process", "ConvertSpreadsheetIntoJSON"),
    # Add useful info for later
    ("cove_rdls.process", "GetDataReaderAndConfigAndSchema"),
    # Convert into output formats
    ("cove_rdls.process", "ConvertJSONIntoSpreadsheets"),
    # Checks and stats
    ("cove_rdls.process", "AdditionalFieldsChecksTask"),
    ("cove_rdls.process", "PythonValidateTask"),
    ("cove_rdls.process", "JsonSchemaValidateTask"),
]
